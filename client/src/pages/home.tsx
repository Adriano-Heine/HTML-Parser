    ...
    <section id="portfolio" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((item) => (
            <div key={item} className="group relative aspect-[4/5] bg-slate-100 rounded-lg overflow-hidden cursor-pointer">
               <div className="absolute inset-0 flex items-center justify-center text-slate-300 font-serif text-2xl">
                 Em Breve
               </div>
               <div className="absolute inset-0 bg-slate-900/0 group-hover:bg-slate-900/60 transition-all duration-300 flex items-end p-6">
                 <div className="text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                   <div className="font-serif text-lg">Projeto {item}</div>
                   <div className="text-xs text-slate-300">Identidade Visual</div>
                 </div>
               </div>
            </div>
          ))}
